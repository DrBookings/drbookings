...
public interface GrossIncomeSupplier extends MonetaryAmountFromBookingsSupplier {

    /**
     * Returns the gross income for this booking entry. That is, the booking gross
     * income per night. All income from all booking entries from the same booking
     * are always the same.
     *
     * @param booking
     *            the {@link BookingEntry} to calculate the income for
