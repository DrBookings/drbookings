...
public interface DrBookingsData {
    ...
    CleaningEntry createAndAddCleaning(String id, String name, LocalDate date, BookingBean booking, boolean black)
     ...
     */
    BookingEntry getFirstBookingEntry(Optional<BookingEntryPair> bookingsThatDay);
     ...
     * @return the last {@link BookingEntry}
     */
    BookingEntry getFirstBookingEntry(String roomName, LocalDate date);
     ...
     * @return the last {@link BookingEntry}
     */
    BookingEntry getLastBookingEntry(Optional<BookingEntryPair> bookingsThatDay);
     ...
     * @return the last {@link BookingEntry}
     */
    BookingEntry getLastBookingEntry(String roomName, LocalDate date);
    ...
    void setCleaning(String name, LocalDate date, BookingBean booking, boolean black);
}
