...
public class StatisticsTableBean {
    ...
    public static StatisticsTableBean applyCleaningStuff(final StatisticsTableBean bean,
	    final Collection<? extends BookingEntry> allBookingsInRange) {
	bean.setCleaningCount((int) BookingEntries.countCleanings(allBookingsInRange));
	// bean.setCleaningCosts((float)
	// BookingEntries.getCleaningCosts(allBookingsInRange));
