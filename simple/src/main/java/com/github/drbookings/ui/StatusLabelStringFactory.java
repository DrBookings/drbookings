...
public class StatusLabelStringFactory {
    ...
    private static String buildAirbnbStringNightCount(final BookingsByOrigin bookings, final boolean complete) {
	return buildStringNightCount("Airbnb", bookings.getAirbnbBookings(), complete);
    }

    private static String buildBookingStringNightCount(final BookingsByOrigin bookings, final boolean complete) {
	return buildStringNightCount("Booking", bookings.getBookingBookings(), complete);
    }

    private static String buildOtherStringNightCount(final BookingsByOrigin bookings, final boolean complete) {
	...
	sb.append("(");
	sb.append(buildStringEarnings(bookings.getAirbnbBookings(), completePayment, netEarnings));
	sb.append(")\t");
	sb.append(buildBookingStringNightCount(bookings, completePayment));
	sb.append("(");
	sb.append(buildStringEarnings(bookings.getBookingBookings(), completePayment, netEarnings));
	sb.append(")\t");
	sb.append(buildOtherStringNightCount(bookings, completePayment));
	sb.append("(");
	sb.append(buildStringEarnings(bookings.getOtherBookings(), completePayment, netEarnings));
	sb.append(")\t");
	sb.append(buildStringNightCount("Total", bookings.getAllBookings(), completePayment));
	sb.append("(");
	sb.append(buildStringEarnings(bookings.getAllBookings(), completePayment, netEarnings));
	sb.append(")");
