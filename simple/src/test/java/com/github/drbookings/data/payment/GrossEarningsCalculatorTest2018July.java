...
public class GrossEarningsCalculatorTest2018July {
    ...
    private static final File testFile = new File("src" + File.separator + "test" + File.separator + "resources"
	    + File.separator + "test-data-2018-07.xml");
	...
	assertThat(a.with(Monetary.getDefaultRounding()), is(Payments.createMondary(5279.9)));
    }
	...
	assertThat(a.with(Monetary.getDefaultRounding()),
		is(Payments.createMondary(148.55 + 308.67 + 239.22 + 187.13 + 199.67)));
    }
