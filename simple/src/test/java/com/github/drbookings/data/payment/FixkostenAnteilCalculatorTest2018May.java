...
public class FixkostenAnteilCalculatorTest2018May {
	...
	final MonetaryAmount anteil = new DefaultFixedCostsAnteilCalculator(YearMonth.of(2018, 05), data.getBookings())
		.getFixkostenAnteil("Booking", true, Payments.getSum(History.getCommonExpenses2018Mai()));
	assertThat(anteil.with(Monetary.getDefaultRounding()), is(Payments.createMondary(1694.57)));
    }

    @Test
    public void testAirbnb01() {
	final MonetaryAmount anteil = new DefaultFixedCostsAnteilCalculator(YearMonth.of(2018, 05), data.getBookings())
		.getFixkostenAnteil("Airbnb", true, Payments.getSum(History.getCommonExpenses2018Mai()));
	assertThat(anteil.with(Monetary.getDefaultRounding()), is(Payments.createMondary(1202.60)));
    }
