...
package com.github.drbookings.data.fee;
...
public class ServiceFeesCalculatorTest2018July {
    ...
    private final YearMonth month = YearMonth.of(2018, 7);
	...
	assertThat(fees.with(Monetary.getDefaultRounding()),
		is(Payments.createMondary(528.1 - 16.91 /* Overbooking Detlef */).with(Monetary.getDefaultRounding())));
