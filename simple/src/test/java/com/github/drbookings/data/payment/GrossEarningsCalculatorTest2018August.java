...
public class GrossEarningsCalculatorTest2018August {
    ...
    private static final File testFile = new File("src" + File.separator + "test" + File.separator + "resources"
	    + File.separator + "test-data-2018-08_2.xml");
	...
	assertThat(a.with(Monetary.getDefaultRounding()),
		is(Payments.createMondary(7462.68 - 95.4 /* cancelled booking */).with(Monetary.getDefaultRounding())));
    }
	...
	assertThat(a.with(Monetary.getDefaultRounding()),
		is(Payments.createMondary(304.81)));
    }
