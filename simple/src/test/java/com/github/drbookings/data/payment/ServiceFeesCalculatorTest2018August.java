...
public class ServiceFeesCalculatorTest2018August {
    ...
    private final YearMonth month = YearMonth.of(2018, 8);
	...
	assertThat(fees, is(Payments.createMondary(758.7216 - ((155.4 - 60) * 0.12 /* PARK HYUNGJIN */))));
